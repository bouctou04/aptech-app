            ...
            <div class="">
                <div class="">
                    <div class="<?= $etape2 ?> form-group">
                        <a href="index.php?page=space&&controller=register" class="waves-effect waves-light btn grey btn-sm">
                            <span class="fa fa-chevron-circle-left"></span> Précedent
                        </a>
                    </div>
                    <div class="form-group">
                        <a href="index.php?page=space&&controller=register&&etape1=administrator" class="<?= $etape1 ?> btn btn-primary w-100 font-weight-bold">Ajouter un(e) adminstrateur</a>
                    </div>
                    <div class="form-group">
                        <a href="index.php?page=space&&controller=register&&etape1=teacher" class="<?= $etape1 ?> btn btn-primary w-100 font-weight-bold">Ajouter un(e) professeur</a>
                    </div>
                    <div class="form-group">
                        <a href="index.php?page=space&&controller=register&&etape1=student" class="<?= $etape1 ?> btn btn-primary w-100 font-weight-bold">Ajouter un(e) Etudiant(e)</a>
                    </div>
                </div>
                <div>
                    <form method="POST">
                                    ...
                                    <div class="<?= $etape2 ?>input-field">
                                        <select name="faculty" id="faculty">
                                            ...
                                            foreach($faculty->findAll("WHERE school_id = $_SESSION[school_id]") as $datas) { ?>
                                                <option value="<?= $datas['id'] ?>"><?= $datas['faculty'] ?></option>
                                                <?php
                                            }
                                            ?>
                                        </select>
                                        <?php
                                        $form->label("faculty", "Filière");
                                        ?>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4">
                                    ...
                                    <div class="<?= $etape2 ?>input-field">
                                        <select name="period" id="period">
                                            ...
                                            foreach($period->findAll("WHERE school_id = $_SESSION[school_id]") as $datas) { ?>
                                                <option value="<?= $datas['id'] ?>"><?= $datas['period'] ?></option>
                                                <?php
                                            }
                                            ?>
                                        </select>
