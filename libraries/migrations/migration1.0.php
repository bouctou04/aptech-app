...
-- jeu. 30 avril 2020 01:32:07 GMT
...
-- -----------------------------------------------------
-- Table `aptech_app`.`users_has_school`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `aptech_app`.`users_has_school` (
`id` INT NOT NULL AUTO_INCREMENT,
`users_id` INT UNSIGNED NOT NULL,
`school_id` INT UNSIGNED NOT NULL,
...
PRIMARY KEY (`id`, `users_id`, `school_id`, `faculty_id`, `level_id`, `period_id`),
INDEX `fk_users_has_school_school1_idx` (`school_id` ASC),
...
ON DELETE NO ACTION
ON UPDATE NO ACTION,
CONSTRAINT `fk_users_has_school_school1`
FOREIGN KEY (`school_id`)
REFERENCES `aptech_app`.`school` (`id`)
ON DELETE NO ACTION
ON UPDATE NO ACTION,
